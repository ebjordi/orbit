...
class Orbit:
    def __init__(self,JD = None, phases = None,K1=108.3,K2=-192.2, T0=57880.634, P=29.1333,e=0.734, omega=126.3, gamma=34.): 
    ...
    @classmethod
    def from_linspace(cls, points=1200,e=0.734, K1=108.3,K2=192.2, omega=126.3, gamma=34):
        T0 = None
        P = None
        phases = np.linspace(0.,1.,points)
